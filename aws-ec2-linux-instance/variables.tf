...
variable "linux_distribution" {
  ...
  description = "The Linux distribution to use for the instance (e.g., amazonlinux2023, ubuntu, etc.)"

  validation {
    condition     = contains(["amazonlinux", "ubuntu22lts", "ubuntu24lts"], var.linux_distribution)
    error_message = "The linux_distribution must be either 'amazonlinux' or 'ubuntu22lts' or 'ubuntu24lts'."
  }
}
